...
export default function Navbar() {
  ...
  return (
    <nav className="w-full relative shadow-md">
      ...
      <div className="w-full flex items-center justify-center bg-slate-800 py-2 md:py-3">
        {/* Desktop Navigation */}
      ...
      <div className={`md:hidden absolute top-full left-0 right-0 bg-slate-800 shadow-lg z-50 border-t border-white/20 overflow-hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
