...
export default function HowToBeSavedPage() {
  ...
  return (
    <main className="font-sans">
      ...
      {/* Content Sections */}
      <section className="w-full bg-white text-custom-gray py-8">
        <div className="w-3/4 mx-auto space-y-8">
          
          {/* 1. God loves you */}
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-custom-gray">1. God loves you.</h2>
            
            <div className="space-y-4 mb-6">
              <div className="bg-white rounded-lg p-4 border-l-4 border-custom-gray">
          ...
          {/* 2. You are a sinner */}
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-custom-gray">2. You are a sinner.</h2>
            
            <div className="bg-white rounded-lg p-4 border-l-4 border-custom-gray mb-6">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-custom-gray">3. Sin separates you from God.</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-custom-gray">4. You can&apos;t save yourself.</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-custom-gray">5. God sent His son Jesus to remove the sin barrier.</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-custom-gray">6. You can receive Jesus Christ through faith.</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-custom-gray">7. Through confession, you can trust in Jesus Christ.</h2>
      ...
      <section className="w-full bg-gray-50 text-black py-16">
        <div className="w-3/4 mx-auto text-center">
          <h2 className="text-3xl font-bold mb-8 text-custom-gray">What&apos;s Next?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-xl font-bold mb-4 text-custom-gray">Learn Our Beliefs</h3>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-xl font-bold mb-4 text-custom-gray">Visit Our Church</h3>
